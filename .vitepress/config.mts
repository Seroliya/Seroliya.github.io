        ...
        items: [
          ...
          { text: "药物滥用白皮书",
            items: [
              ...
              { text: '第三章：从药理上区分od和毒品，心理类和趋乐类', link: '/社会思考/药物滥用白皮书/第三章：从药理上区分od和毒品，心理类和趋乐类' },
              { text: '第四章：药滥现象的扩散与其引发的问题', link: '/社会思考/药物滥用白皮书/第四章：药滥现象的扩散与其引发的问题' },
              { text: '第五章+第六章：理解包容为何难以落实；上位式的科普和措施问题所在', link: '/社会思考/药物滥用白皮书/第五章+第六章：理解包容为何难以落实；上位式的科普和措施问题所在' },
